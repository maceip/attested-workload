...
//!   us-central1-a, Linux 6.17, stage 0 via `aw build`, stage 1
//!   via `aw run` chaining stage 0.
...
//!   `aw enclave`), AL2023 parent, debug-mode enclave. No
...
use attested_workload::eat::EatToken;
use attested_workload::quote::{verify::verify_platform_quote, Platform};
use std::fs;
...
/// is the first time attested-workload was built inside a TEE *as a CI step
