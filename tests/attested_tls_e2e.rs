...
//! `aw enclave`, the same flow produces a genuine quote whose
//! AMD/Intel signature chain verifies.

use attested_workload::eat::{BuildComponents, EatToken};
use attested_workload::net::attested_tls::{
    extract_eat_from_cert, generate_keypair, make_attested_cert, spki_hash_of, spki_hash_of_cert,
};
use attested_workload::quote::Platform;
