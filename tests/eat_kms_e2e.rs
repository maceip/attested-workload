...
//!
//! ```bash
//! aw enclave ./target-source --cmd "cargo build --release"
//! # In another terminal, from the parent:
//! aw proxy --cid <enclave-cid>
...
use attested_workload::eat::{BuildComponents, EatToken, EAT_PROFILE, EAT_VERSION};
use attested_workload::quote::{verify, Platform};
