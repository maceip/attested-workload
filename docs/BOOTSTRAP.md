...
vTOM/paravisor model did not expose attested-workload's current raw SNP evidence
interfaces:
...
fresh attested-workload quote because the current producer needs to place
